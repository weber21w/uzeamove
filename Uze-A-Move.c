...
PGM_P const bg_maps[] PROGMEM = {
map_bg0, map_bg1, map_bg2, map_bg3, map_bg4, map_bg5, map_bg6, map_bg7, map_bg8, map_bg9, map_bg10, map_bg11,
};
...
void draw_bg( unsigned char bg_frame ) {
	...
	for( x=0 ; x<5 ; x++ ) {
		for( y=0 ; y<3 ; y++ ) {
			DrawMap2( x*6, y*6, (const char *)pgm_read_word(&bg_maps[bg_frame]));
		}
	}
}
